...
use \Paris\ORMWrapper;
use \Paris\MethodMissingException;
...
class Model {
	 ...
	 * @example \Paris\Model::$auto_prefix_models = 'MyProject_MyModels_'; //PEAR
	 * @example \Paris\Model::$auto_prefix_models = '\MyProject\MyModels\'; //Namespaces
	 * @var string
	 */
